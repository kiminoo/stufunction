...
const Q8StrategyBCConfirmation = (props) => {

    const Q8StrategyBCConfirmation = useState("Q8 Strategy Confirmation")
    const Confirmation = useState("Nice work!\nThat’s correct!")
    return (
    <View style ={styles.mainView}>
            
            <Text style = {styles.labelTitle}>
            {Q8StrategyBCConfirmation}
            </Text>
...
export default Q8StrategyBCConfirmation;